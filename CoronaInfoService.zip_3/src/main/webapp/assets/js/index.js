$(function(){
    $.ajax({
        type:"get",
        url:"/api/corona/age/today", //today
        success:function(r) {
    ...
    $.ajax({
        type:"get",
        url:"/api/corona/gen/today",//today
        success:function(r) {
            console.log(r);
            let confArr = new Array();
            let confLabel = new Array();
    ...
    $.ajax({
        type:"get",
        url:"/api/coronaInfo/today",//today
        success:function(r) {
            console.log(r);
    ...
    $.ajax({
        type:"get",
        url:"/api/coronaSidoInfo/today",//today
        success:function(r) {
            console.log(r);
    ...
    $.ajax({
        type:"get",
        url:"/api/corona/vaccine/today",//today
        success:function(r) {
            console.log(r);
